...
def add_motrix_tracking_frame_sensors(*args, **kwargs):
    raise NotImplementedError("Motrix backend is removed in MiniLab-Hand")

def materialize_motrix_hfield_attached_scene(*args, **kwargs):
    raise NotImplementedError("Motrix backend is removed in MiniLab-Hand")

def materialize_motrix_scene(*args, **kwargs):
    raise NotImplementedError("Motrix backend is removed in MiniLab-Hand")
