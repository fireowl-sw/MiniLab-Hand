...
from minilab.utils.tensor import to_numpy, to_torch
...
def normalize_ppo_train_cfg(train_cfg: dict[str, Any]) -> dict[str, Any]:
    """Map MiniLab PPO owner config to the current RSL-RL schema."""
...
class RslRlVecEnvWrapper:
    """Adapter from MiniLab's env contract to the RSL-RL VecEnv contract."""
