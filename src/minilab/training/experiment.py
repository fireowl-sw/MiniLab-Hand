...
def build_wandb_settings(
    ...
    *,
    ...
    return {
        "project": _cfg_get(training_cfg, "wandb_project", "minilab"),
...
def patch_rsl_rl_wandb_writer() -> None:
    ...
    if getattr(wandb_utils, "_MINILAB_PATCHED", False):
        return
    ...
    class PatchedWandbSummaryWriter(TensorboardSummaryWriter):
        def __init__(self, log_dir: str, flush_secs: int, cfg: dict) -> None:
            ...
            project = cfg.get("wandb_project", "minilab")
    ...
    setattr(wandb_utils, "_MINILAB_PATCHED", True)
...
def patch_rsl_rl_resume_state() -> None:
    ...
    a ``minilab_logger_state`` key in the saved dict. Legacy checkpoints (without
    ...
    if getattr(OnPolicyRunner, "_MINILAB_RESUME_PATCHED", False):
        return
    ...
    def _patched_save(self: Any, path: str, infos: dict | None = None) -> None:
        ...
        saved_dict["minilab_logger_state"] = {
    ...
    def _patched_load(
        ...
        state = loaded_dict.get("minilab_logger_state")
    ...
    OnPolicyRunner._MINILAB_RESUME_PATCHED = True  # type: ignore[attr-defined]
