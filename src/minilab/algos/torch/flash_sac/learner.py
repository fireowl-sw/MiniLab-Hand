"""FlashSAC learner adapted to MiniLab's off-policy contract."""
...
from minilab.algos.torch.flash_sac.network import (
    FlashSACActor,
    FlashSACDoubleCritic,
    FlashSACTemperature,
)
from minilab.algos.torch.flash_sac.update import (
    build_lr_lambda,
