...
def _normalize_obs_groups_for_rsl(cfg: dict[str, Any]) -> None:
    """Translate MiniLab owner obs-group aliases into RSL-RL actor/critic groups.
...
def convert_config_v3_to_v4(cfg: dict[str, Any]) -> dict[str, Any]:
    """Convert a legacy MiniLab PPO/APPO config into the RSL-RL v4 schema.
...
def convert_config_v5(cfg: dict[str, Any]) -> dict[str, Any]:
    """Convert a legacy MiniLab PPO/APPO config into the RSL-RL v5 schema.
