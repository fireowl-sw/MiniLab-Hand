...
from minilab.base.final_observation import resolve_terminal_observation_contract
from minilab.base.observations import get_obs_dims, split_obs_dict
from minilab.base.registry import ensure_registries
from minilab.training.seed import apply_training_seed
...
def resolve_offpolicy_actor_priv_info(
    *,
    ...
    from minilab.algos.torch.hora.observations import split_hora_obs_with_priv_info
...
def _run_collector(
    ...
    from minilab.ipc import SharedWeightSync
    ...
    while not stop_event.is_set():
        ...
        # ReplayBuffer `dones` follows the MiniLab env lifecycle contract:
