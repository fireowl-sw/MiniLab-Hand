...
def build_actor(
    ...
    **kwargs,
    ...
    if algo_type == "sac":
        from minilab.algos.torch.fast_sac.learner import SACActor
    ...
    if algo_type == "hora_sac":
        ...
        from minilab.algos.torch.hora.sac_models import HoraSACActor
    ...
    if algo_type == "td3":
        from minilab.algos.torch.fast_td3.learner import TD3Actor
    ...
    if algo_type == "flashsac":
        from minilab.algos.torch.flash_sac.network import FlashSACActor
