...
from minilab.algos.torch.appo.learner import APPOLearner
from minilab.algos.torch.appo.staging import RolloutStagingPool
from minilab.algos.torch.appo.worker import appo_collector_fn
from minilab.ipc import AsyncRunner, RolloutRingBuffer, SharedWeightSync
...
class APPORunner(AsyncRunner):
    ...
    def learn(
        ...
        # --- memory budget check ---
        from minilab.ipc.memory_budget import estimate_appo_bytes, warn_if_over_budget
