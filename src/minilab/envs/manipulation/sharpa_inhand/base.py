...
from minilab.base.base import EnvCfg
from minilab.base.np_env import NpEnv, NpEnvState
from minilab.base.scene import SceneCfg
from minilab.dtype_config import get_global_dtype
from minilab.envs.common.rotation import np_quat_apply, np_quat_mul
...
class SharpaInhandBaseEnv(NpEnv):
    ...
    def _compute_contact_positions(self, tactile: np.ndarray) -> np.ndarray:
        ...
        # current MiniLab sensor contract, so we keep this channel as zeros for now.
