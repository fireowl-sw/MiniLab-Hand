...
from minilab.base.backend import SimBackend
from minilab.base.backend.base import BackendPlayRenderPlan
from minilab.base.base import ABEnv, EnvCfg, EnvPlayCapabilities
from minilab.base.scene import SceneCfg
from minilab.dr import DomainRandomizationManager, DomainRandomizationProvider
from minilab.dtype_config import get_global_dtype

if TYPE_CHECKING:
    from minilab.base.augmentation import SymmetryAugmentation
    from minilab.utils.nan_guard import NanGuard
...
class NpEnv(ABEnv):
    ...
    def _init_domain_randomization(self, provider: "DomainRandomizationProvider") -> None:
        from minilab.dr import DomainRandomizationManager
