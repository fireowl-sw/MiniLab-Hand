...
def _prepare_variant_model_xml(
    ...
    *,
    ...
    from minilab.base.backend.mujoco.xml import (
...
def _compile_model_variant_chunk_to_mjb(
    *,
    ...
    output_dir = tempfile.mkdtemp(prefix="minilab-mj-variant-")
    try:
...
def _build_mujoco_scene_context(scene: SceneCfg) -> _MuJoCoSceneContext:
    ...
    output_dir = tempfile.TemporaryDirectory(prefix="minilab_scene_")
    try:
