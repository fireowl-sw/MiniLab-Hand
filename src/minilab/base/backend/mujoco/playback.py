...
from minilab.base.backend.playback_common import env_cfg_value
...
def run_mujoco_playback(
    *,
    ...
    from minilab.visualization import render_many
    ...
    with tempfile.TemporaryDirectory(prefix="minilab-playback-models-") as tmp_dir:
