...
from minilab.ipc.replay_pipelines.base import ReplayTickMetadata
...
class CudaLikeReplayTransferBackend:
    ...
    def __init__(self, *, device: torch.device, ring_depth: int) -> None:
        ...
        if self.h2d_submitter == "pybind11":
            from minilab.ipc.replay_pipelines.native_h2d import get_diagnostic, is_available
        ...
        *,
        ...
        with torch.cuda.device(self.device):
            ...
            with torch.cuda.stream(copy_stream):
                ...
                if self.h2d_submitter == "pybind11":
                    from minilab.ipc.replay_pipelines.native_h2d import submit_h2d
